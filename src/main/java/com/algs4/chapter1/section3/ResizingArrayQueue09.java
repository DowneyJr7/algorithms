 ...
 *  @author Kevin Wayne
 */
public class ResizingArrayQueue09<Item> implements Iterable<Item> {
    ...
    public static void main(String[] args) {
        ResizingArrayQueue09<String> queue = new ResizingArrayQueue09<String>();
        while (!StdIn.isEmpty()) {
